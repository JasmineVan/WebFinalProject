...
<?php 
	...
	$sql = "SELECT * FROM dayoff WHERE EmployeeID IN(
        ...
        ) AND LeaderFlag = '0' AND RequestStatus = '1'
    )";
			...
			<tr>
                ...
                <td>
                    ...
                    <button type='submit' class='btn btn-success'>
                        <a href="../dayoffController/leaderRequestApprove.php?dayoffID=<?= $dayoffID ?>" class="text-white no-underline">Approve</a>
                    </button>
                    <button type='submit' class='btn btn-danger'>
                        <a href="../dayoffController/leaderRequestReject.php?dayoffID=<?= $dayoffID ?>" class="text-white no-underline">Reject</a>
                    </button>
                </td>
			</tr>
            <thead class="thead-light">
