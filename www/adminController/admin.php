...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <ul class="navbar-nav">
            ...
            <li class="nav-item ">
                <a class="nav-link" href="../adminController/admin2.php"><i class="fas fa-chevron-right"></i></a>
            </li>
            <li class="nav-item ">
    ...
    <table>
        <tr>
            <td>
                <form action="../employee/newEmployee.php" method="POST">
                    <button type="submit" class="btn btn-success m-2">New employee</button>
                </form>
            </td>
        </tr>
    </table>
    ...
    require("../employee/employeeList.php");
    ?>
</body>
<?php
	}else{
